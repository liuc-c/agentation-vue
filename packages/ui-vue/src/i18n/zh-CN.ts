...
export const zhCN: Messages = {
  ...
  settings: {
    ...
    agentWorkspaceDescription: "在同一个面板里完成选择 agent、连接 agent 和发送待处理批注。",
    ...
    connectAgentToStart: "先连接当前 agent，再发送任务。",
    sendPendingToStart: "把待处理批注发送给已连接的 agent。",
    installAgentHint: "请先在当前机器安装对应 CLI，再连接。",
    installAgent: "先安装",
    openHomepage: "打开官网",
