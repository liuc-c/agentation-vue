...
export const en: Messages = {
  ...
  settings: {
    ...
    agentSessionsDescription: "Review current and historical page sessions for this project. Closing a session keeps it in history and stops new work from using it.",
    agentSessionsCount: (active, total) => `${active} active / ${total} total`,
